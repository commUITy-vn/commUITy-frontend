...
export const createSupportNeedTransferTicket = (
  ...
  api.post(
    `/api/v1/money-transfer-tickets/support-needs/${supportNeedId}`,
    data,
  );

export const getMyMoneyTransferTickets = (): Promise<
  MoneyTransferTicketResponse[]
...
export const resolveMoneyTransferTicket = (
  ...
  return api.patchForm(
    `/api/v1/money-transfer-tickets/admin/${ticketId}/resolve`,
    formData,
  );
};
